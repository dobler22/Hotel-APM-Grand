<%@ Page Title="Contacto" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Contacto.aspx.cs" Inherits="Presentacion.Contacto" %>
        ...
        <div class="pt-4 border-top">
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-md-5 col-lg-4">
                    <div class="card shadow-sm border-0 rounded-3 text-center p-3 h-100">
                        <div class="avatar-frame mt-2">
                            <img src="Assests/Anthony_Samuel_Quishpe_Alvarado.jpeg" alt="Anthony Quishpe" class="avatar-img" />
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-5 col-lg-4">
                    <div class="card shadow-sm border-0 rounded-3 text-center p-3 h-100">
                        <div class="avatar-frame mt-2">
                            <img src="Assests/Sleyder_Dario_Moreno_Crespo.jpeg" alt="Sleyder Moreno" class="avatar-img" />
                        </div>
                        <div class="card-body">
